...
import toughdevschool.ates.analytics.domain.user.handler.UserCreateHandler
import toughdevschool.ates.analytics.domain.user.handler.UserUpdateHandler
import toughdevschool.ates.analytics.domain.userRole.handler.UserRoleCreateHandler
import toughdevschool.ates.analytics.domain.userRole.handler.UserRoleDeleteHandler
...
class AccountsCudEventConsumer(
    ...
    override val consumerName = "accounts-cud-consumer"
